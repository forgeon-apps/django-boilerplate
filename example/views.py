...
def home_page(request):
    body = """
        <div class="grid">
          <div>
            <div class="eyebrow">Forgeon · Django playground</div>
            <h1>Django boilerplate, ready for deploy tests.</h1>
            <p>
              This service is a small Django HTTP app you can use to test routing,
            ...
            <div class="pill-row">
              ...
              <div class="pill">Django · ASGI/WSGI</div>
          ...
          <div>
            <div class="links">
              ...
              <a href="/framework">
                /framework
                <span>– stack: Django, Python, etc.</span>
              </a>
              <a href="/status">
                /status
        ...
        <div class="meta">
          <span>Try deploying this to Forgeon as a simple Django playground.</span>
          <span class="badge">127.0.0.1:8000</span>
        </div>
    """
    return HttpResponse(html_shell("Forgeon Django playground", body))
...
def info_page(request):
    body = """
        ...
        <div class="grid">
          <div>
            ...
            <h1>djangoapi · Forgeon-ready microservice</h1>
            <p>
    ...
    """
    return HttpResponse(html_shell("Forgeon · Django Playground · Info", body))
...
def about_page(request):
    body = """
        ...
        <div>
          ...
          <h1>Django app wired for Forgeon.</h1>
          <p>
            This tiny service is a <strong>Django</strong> playground used to test how
          ...
          <ul>
            <li>Boots fast with no DB configured.</li>
            <li>Has HTML endpoints for visual checks.</li>
            <li>Has JSON endpoints for programmatic checks.</li>
          </ul>
        </div>
    """
    return HttpResponse(html_shell("Forgeon · About this Django demo", body))
...
def framework_page(request):
    body = """
        ...
        <div class="grid">
          <div>
            ...
            <h1>Built with Django & Python.</h1>
            <p>
              The service uses <strong>Django</strong> for routing and views, and can be
              served via <strong>Gunicorn</strong> or <strong>Uvicorn</strong> behind Forgeon.
              In playground mode it runs without any database.
            </p>
          </div>
    ...
    """
    return HttpResponse(html_shell("Forgeon · Django Framework stack", body))


def status_view(request):
    """Simple JSON health endpoint suitable for Forgeon health checks."""
    now = datetime.utcnow().isoformat() + "Z"
    data = {
        "status": "ok",
        "service": "django-playground",
        "timestamp": now,
    }
...
def v1_index(request):
    """JSON API index – mirrors the concept of /v1 in the Rust version."""
    data = {
        "message": "Django API v1 index",
        "service": "django-playground",
        "routes": {
